...
trait common_html_user_history
{
	private function create_table_activity_distribution_hour(): ?string
	{
		...
		if ($page === 'html') {
			...
			$result = db::query_single_row('SELECT l_00, l_01, l_02, l_03, l_04, l_05, l_06, l_07, l_08, l_09, l_10, l_11, l_12, l_13, l_14, l_15, l_16, l_17, l_18, l_19, l_20, l_21, l_22, l_23, l_total FROM ruid_lines WHERE l_total != 0 AND ruid = '.$this->ruid);
		} elseif ($page === 'history') {
